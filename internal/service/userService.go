...
func (us *UserServ) CreateUser(user entity.User) (userInfo entity.UserResponse, err error) {
...
func (us *UserServ) GetUserById(id int) (entity.UserResponse, error) {
...
func (us *UserServ) GetUserValidation(code, email string) (entity.UserResponse, error) {
	user, err := us.userRepo.GetByEmail(email)
	if err != nil {
	...
	if user.ValidationStatus {
		...
		return entity.UserResponse{}, fmt.Errorf("already validate")
	}
